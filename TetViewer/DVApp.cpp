...
{	
...
#else
	if (!wxXmlResource::Get()->Load(_T("TetViewer.xrc"))) return false; //load GUI resource from xrc file
#endif
	...
	{
		((wxNotebook*)frame->FindWindowById(XRCID("m_notebook_panels")))->SetSelection(3);
	}
