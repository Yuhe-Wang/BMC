...
DVFrame::DVFrame(wxWindow* parent) :gl(NULL), pSimu(NULL), bMarkClose(false)
{
	...
	const char* panelName[] = { "Panel_controls", "Panel_dose", "Panel_external" };
	const char* showName[] = { "controls", "dose", "external" };
	...
	{
		//name, resource, hint
		"m_tool_open", "res/open.bmp", "open mdose",
...
void DVFrame::OnAbout(wxCommandEvent& event)
{
	...
	aboutInfo.SetName("TetViewer");
	aboutInfo.SetVersion("1.0");
	aboutInfo.SetDescription(_("This app views the tetrahedral phantom and the dose distribution in 3 dimensions!"));
	aboutInfo.SetCopyright("(C) 2016 WUSTL Medical School");
