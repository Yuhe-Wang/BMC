...
public:
	...
	void setOrgID();
	void recursiveWalk(int& ix, int& iy, int& iz, int offx, int offy, int offz, int layer, SFloat walked);
	...
	bool inSkin(int ix, int iy, int iz); 
	...
	ArrayMgr<SFloat> orgid; //organ id; 0 -> important region, need detailed simulation, -1 -> not important region, will calculate distance to the important region in CPU or GPU
