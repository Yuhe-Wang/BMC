...
ZEUS =
{
	Simulate electron = no # yes or no
...
SOURCEHEAD =
{
	...
	Leaf spacing adjustment = $LeafAdjustment$ # unit cm. Currently default to -0.07
...
TET_MESH =
{
	mesh file = test.mat #currently only accept matlab file which should contains variable elem and node
	mesh adjustment = 0 0 0 1 # the first three numbers form a translation vector, and the fourth number is scaling factor
