...
public:
	...
	void setLVol(ArrayMgr<uint32_t>* in_lvol)
	{
		lvol = in_lvol; //remember the pointer of the reference dose
	}
...
protected:
	...
	ArrayMgr<uint32_t>* lvol; // pointer of the important region matrix
